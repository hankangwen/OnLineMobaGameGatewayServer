...
public static class Gateway
{
    ...
    /// 接收服务端的udp
    /// </summary>
    private static UdpClient _receiveServerUdp;
    ...
    private static void AcceptServerCallback(IAsyncResult ar)
    {
        ...
        //udp
        _receiveServerUdp = new UdpClient((IPEndPoint)gateway.LocalEndPoint);
        _receiveServerUdp.BeginReceive(ReceiveUdpServerCallback, serverState);
    ...
    private static void Accept(Socket listenfd)
    {
        try
        {
            ...
            _receiveClientUdp.BeginReceive(ReceiveUdpClientCallback, state);
    ...
    private static void ReceiveUdpClientCallback(IAsyncResult ar)
    {
        ...
        byte[] receiveBuf = _receiveClientUdp.EndReceive(ar, ref iPEndPoint);
    ...
    private static void ReceiveUdpServerCallback(IAsyncResult ar)
    {
        ...
        IPEndPoint iPEndPoint = new IPEndPoint(IPAddress.Any, 0);
        byte[] receiveBuf = _receiveServerUdp.EndReceive(ar, ref iPEndPoint);
